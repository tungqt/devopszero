...
## Mục đích
Bộ não vận hành của Workspace. Nơi chứa các quy chuẩn để tôi và AI làm việc ăn ý, bao gồm:
- Cách AI xưng hô và giao tiếp.
- Template chuẩn cho các loại tài liệu.
- Quy tắc viết code (Coding standards).
- Quy trình đọc và quản lý file.
